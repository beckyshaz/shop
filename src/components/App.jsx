...
import { CreateProductInCart } from "./Cart";
...
function App() {
   ...
   function getAddedProduct(id) {
    ...
    return (
        <div>
            <HomePg />
            < Shop products={products} onAddToCart={addToCartHandler} />
            <CreateProductInCart cart={cart} onRemoveFromCart={removeFromCartHandler} />
        </div>
    )
}
